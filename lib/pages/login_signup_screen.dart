        ...
        child: Consumer(builder: (context, watch, _) {
          ...
          return LayoutBuilder(builder: (context, constraints) {
            if (constraints.maxWidth < 830)
              return mobileLogin(context, _onPressedFunction);
            return webLogin(context, _onPressedFunction);
          });
        }),
      ),
    );
                      ...
                      child: _isLoading
                          ...
                          : MaterialButton(
                              ...
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(25),
                                side:
                                    BorderSide(color: TwitterTheme.blueTColor),
                              ),
                            ),
                    ),
                    Spacer(),
                          ...
                          children: [
                            TextSpan(
                                text: type == Status.login
                                    ...
                                    : 'Log in',
                                style:
                                    TextStyle(color: TwitterTheme.blueTColor),
                                recognizer: TapGestureRecognizer()
                                  ..onTap = () {
                                    _switchType();
                                  })
